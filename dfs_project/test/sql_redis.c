...
int main()
{
	...
	//第1条数据
	strcpy(sql_cmd, "insert into file_info (file_id, filename, user) values ('group1/M00/00/01/wKgfbVh2AGKASftLAAD-JOf3Vps147.jpg', '1.jpg', 'mike')");
	...
	//第2条数据
	strcpy(sql_cmd, "insert into file_info (file_id, filename, user) values ('group1/M00/00/01/wKgfbVhzLM2AQSGKAABHtjRwEY0951.jpg', '2.jpg', 'mike')");
	...
	//第3条数据
	strcpy(sql_cmd, "insert into file_info (file_id, filename, user) values ('group1/M00/00/01/wKgfbVhzppyAJQfcAACA0qRB_do611.jpg', '3.jpg', 'mike')");
    ...
    if (retn < 0) //如果没有数据，从mysql中取数据
	{
		...
		strcpy(sql_cmd, "select file_id from file_info where user = 'mike'"); //sql语句
